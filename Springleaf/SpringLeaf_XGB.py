...
# xgb_clf = xgb.XGBClassifier(max_depth=8, learning_rate=.015, n_estimators=10, subsample=.8, \
#                             colsample_bytree=.8)
...
grid_params = {'max_depth':[6, 10, 14],'learning_rate':[.010, .015, .020], \
               'n_estimators':[2000], 'subsample':[.7, .9], 'colsample_bytree':[.6, .8]}
...
submission.to_csv('B_XGB_GridSearch_2015_10_11.csv')


sklearn.externals.joblib.dump(best_xgb, './models/XGB_2015_10_11.pkl')
sklearn.externals.joblib.dump(encoders, './models/XGB2_encoders_2015_10_11.pkl')
