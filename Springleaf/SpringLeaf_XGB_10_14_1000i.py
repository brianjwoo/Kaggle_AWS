...
xgb_clf = xgb.XGBClassifier(max_depth=20, learning_rate=.020, n_estimators=1000, subsample=.9, \
                             colsample_bytree=.6)
...
submission.to_csv('B_XGB_GridSearch_2015_10_14_1000iterations.csv')
