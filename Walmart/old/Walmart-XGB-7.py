...
X_, X_val, y_, y_val = train_test_split(X_train, y_train, test_size = 20000, random_state = 13)
...
submission.to_csv('Walmart_submission_XGB_7000Features-7.csv', index=False)
...
cm_df.to_csv('Walmart_Confusion_Matrix-7.csv')
